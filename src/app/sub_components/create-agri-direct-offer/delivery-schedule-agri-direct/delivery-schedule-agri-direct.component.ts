...
@Component({
  selector: 'delivery-schedule-agri-direct',
  templateUrl: './delivery-schedule-agri-direct.component.html',
  styleUrls: ['./delivery-schedule-agri-direct.component.scss']
})
export class DeliveryScheduleAgriDirectComponent implements OnInit {
  @Input() goodsList: GoodsItemModel[] = [];
