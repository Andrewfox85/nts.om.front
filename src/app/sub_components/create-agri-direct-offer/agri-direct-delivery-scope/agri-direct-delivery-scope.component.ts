...
@Component({
  selector: 'agri-direct-delivery-scope',
  templateUrl: './agri-direct-delivery-scope.component.html',
  styleUrls: ['./agri-direct-delivery-scope.component.scss']
})
export class AgriDirectDeliveryScopeComponent implements OnInit {
